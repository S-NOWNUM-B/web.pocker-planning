...
// Компонент AboutPage представляет собой страницу, которая объясняет, почему существует проект Pocker Planning, какие проблемы он решает, и как он может быть полезен для различных ролей в команде. Страница структурирована в несколько секций с заголовками, текстом и карточками для визуального представления информации. В конце страницы есть FAQ и ссылка на репозиторий проекта для дальнейшего изучения и участия.
